...
function Footer() {
  return (
    <footer className="footer py-5" style={{ color: "black",backgroundColor:"#a9ab99" }}>
      <div className="container1" style={{ padding: "2rem" }}>
        <div className="row">
          <div className="col-lg-4 col-md-6 mb-4 mr-5">
            <h4 style={{color:"#ac6765"}}>About Us</h4>
            <p>
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <h4 style={{color:"#ac6765"}}>Quick Links</h4>
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <h4 style={{color:"#ac6765"}}>Contact Us</h4>
            <ul className="list-unstyled">
        ...
        <div
          ...
          style={{ backgroundColor: "#ac6765", padding: "10px" }}
        >
          © 2025 Copyright: Rent A Car
        </div>
      </div>
    </footer>
  );

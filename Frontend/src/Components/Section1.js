...
function Section1() {
  return (
    <div className="mycontainer my-5" style={{ backgroundColor: "#a9ab99",margin:"5%" }}>
      <div className="row align-items-center">
        <div className="col-lg-7 col-md-6 col-12 mb-4 mb-md-0">
          <h2 className="mb-4 fw-bolder fs-1" style={{color:"#ac6765"}}>Rent A Car</h2>
          <p className="mb-4 me-5 fs-5">
            Rent A Car is a globally renowned car rental brand that has redefined
          ...
          <button className="btn btn-dark mb-4" style={{backgroundColor:"#ac6765"}}>Read More</button>
        </div>
